...
let CrudService = class CrudService {
    constructor(platform, sqlite) {
        ...
        this.sqlite = sqlite;
        this.db_name = "favoritess.db";
        this.db_table = "favTable";
        this.aux = 1;
    }
    databaseConn() {
        this.platform.ready().then(() => {
            this.sqlite.create({ name: this.db_name, location: 'default' }).then((sqLite) => {
    ...
    addItem(u, fi, fn, fd) {
        ...
        this.dbInstance.executeSql(`INSERT INTO ${this.db_table}(user_uuid, festival_id, festival_name, festival_desc) VALUES ('${u}','${fi}','${fn}', '${fd}')`, [])
            .then(() => {
            // alert("Success");
...
const attachComponent = /*#__PURE__*/function () {
  var _ref = (0,C_Users_Minerva_Desktop_otroMas_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (delegate, container, component, cssClasses, componentProps, inline) {
    var _a;
...
const CoreDelegate = () => {
  ...
  const attachViewToDom = /*#__PURE__*/function () {
    var _ref2 = (0,C_Users_Minerva_Desktop_otroMas_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (parentElement, userComponent, userComponentProps = {}, cssClasses = []) {
      var _a, _b;
...
const getScrollElement = /*#__PURE__*/function () {
  var _ref = (0,C_Users_Minerva_Desktop_otroMas_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el) {
    if (isIonContent(el)) {
      yield new Promise(resolve => (0,_helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_1__.c)(el, resolve));
...
const openURL = /*#__PURE__*/function () {
  var _ref = (0,C_Users_Minerva_Desktop_otroMas_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (url, ev, direction, animation) {
...
module.exports = "p {\n  font-size: small;\n}\n\n.iconos-size {\n  height: 1vw;\n  width: 1vw;\n}\n\n.footer {\n  height: 10vw;\n}\n\nh4 {\n  font-weight: bold;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
...
module.exports = "\n\n\n<footer class=\"pie_pagina py-4 text-center text-lg-start footer\">\n  <div class=\"container\">\n    <div class=\"row justify-content-center\" >\n      <!--Información empresa-->\n      <div class=\"col-xs-12 col-sm-3\" >\n        <h4>Conócenos</h4>\n        <p >Somos una empresa destinada a buscar el festival que mejor se adapte a ti.</p>\n        <p>Te mereces un festival.</p>\n      </div>\n      <!--Información empresa-->\n      <!--Información contacto-->\n      <div class=\"col-xs-12 col-sm-3 \">\n\n        <h4 class=\"centrado\" style=\"font-size: x-medium ;\">Contacto</h4>\n        <p>\n          695284756\n          <br>\n          698521474\n        </p>\n      </div>\n      <!--Información contacto-->\n      <!--Redes sociales-->\n      <div class=\"col-xs-12 col-sm-3\">\n        <h4 class=\"centrado\">Síguenos</h4>\n        <p>\n          <!-- Facebook -->\n          <img  class=\"imgFooter iconos-size\" src= \"https://cdn-icons-png.flaticon.com/512/44/44646.png\">\n          Facebook <br>\n          <!-- Instagram -->\n          <img  class=\"imgFooter iconos-size\" src=\"https://cdn-icons-png.flaticon.com/512/87/87390.png\">\n          Instagram <br>\n          <!-- Twitter -->\n          <img  class=\"imgFooter iconos-size\" src = \"https://cdn-icons-png.flaticon.com/512/60/60580.png\">\n          Twitter\n      </p>\n      </div>\n      <!--Redes sociales-->\n      <!--Aviso legal-->\n      <div class=\"col-xs-12 col-sm-3\">\n        <h4 class=\"centrado\">Aviso legal</h4>\n        <p>xxxxxxxxxxxx <br> xxxxxxxxxxxx</p>\n      </div>\n      <!--Aviso legal-->\n    </div>\n  </div>\n</footer>\n\n";
