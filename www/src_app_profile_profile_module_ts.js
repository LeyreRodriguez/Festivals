...
/* harmony import */ var _services_FirebaseRepository_firebase_repository_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../services/FirebaseRepository/firebase-repository.service */ 4423);
...
let ProfilePage = class ProfilePage {
    constructor(authService, router, fireRepoSvc) {
        this.authService = authService;
        this.router = router;
        this.fireRepoSvc = fireRepoSvc;
        this.formData = new FormData();
        this.fileName = '';
        this.isCompany = false;
        this.editDataForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_4__.FormGroup({
            ...
            photoUrl: new _angular_forms__WEBPACK_IMPORTED_MODULE_4__.FormControl(''),
            userName: new _angular_forms__WEBPACK_IMPORTED_MODULE_4__.FormControl('')
        });
        this.fileForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_4__.FormGroup({
    ...
    loadFile() {
        ...
        return (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__awaiter)(this, void 0, void 0, function* () {
            if (this.formData.get('file')) {
                ...
                yield this.fireRepoSvc.csTask(this.fileName, file, this.id);
                let ref = yield this.fireRepoSvc.csReference(this.fileName, this.id);
                ...
                (_a = this.fileForm.get("file")) === null || _a === void 0 ? void 0 : _a.reset();
            }
            else {
...
ProfilePage.ctorParameters = () => [
    ...
    { type: _services_FirebaseRepository_firebase_repository_service__WEBPACK_IMPORTED_MODULE_3__.FirebaseRepositoryService }
];
...
/***/ 4423:
/*!****************************************************************************!*\
  !*** ./src/app/services/FirebaseRepository/firebase-repository.service.ts ***!
  \****************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "FirebaseRepositoryService": () => (/* binding */ FirebaseRepositoryService)
/* harmony export */ });
...
let FirebaseRepositoryService = class FirebaseRepositoryService {
    constructor(storage) {
    ...
    csTask(file, data, id) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__awaiter)(this, void 0, void 0, function* () {
            return yield this.storage.ref("users").child(id + "/" + file).put(data);
        });
    }
    // File's reference
    csReference(file, id) {
...
FirebaseRepositoryService.ctorParameters = () => [
    { type: _angular_fire_compat_storage__WEBPACK_IMPORTED_MODULE_1__.AngularFireStorage }
];
FirebaseRepositoryService = (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__decorate)([
...
/* harmony import */ var firebase_compat_storage__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! firebase/compat/storage */ 2365);
...
/* harmony export */ });
/* harmony import */ var C_Users_Minerva_Desktop_otroMas_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 1670);
...
function _listAllHelper() {
  _listAllHelper = (0,C_Users_Minerva_Desktop_otroMas_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (ref, accumulator, pageToken) {
    const opt = {
...
class FirebaseStorageImpl {
  ...
  _getAuthToken() {
    ...
    return (0,C_Users_Minerva_Desktop_otroMas_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
...
module.exports = ".loadFile, .saveChanges, .changeFile {\n  border: none !important;\n}\n\ninput {\n  border-top: 0;\n  border-left: 0;\n  border-right: 0;\n  outline: none;\n  border-bottom: 1px solid #d1e3eb;\n}\n\nlabel {\n  font-weight: bold;\n}\n\n.loadFile {\n  background-color: #d1e3eb !important;\n  color: black;\n  font-weight: bold;\n}\n\n.saveChanges {\n  background-color: #7cffc5 !important;\n  color: black;\n  font-weight: bold;\n}\n\n.noEditable {\n  cursor: default;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
...
module.exports = "<ion-content>\n  <div\n    class=\"profile-container d-flex flex-column justify-content-center mx-auto col-3 mt-3 p-2\"\n    style=\"width: 100%;\">\n\n    <img class=\"userPhoto\" src=\"{{userPhoto}}\" class=\"rounded-circle mx-auto my-4\" style=\"width: 15%;\">\n\n    <form [formGroup]=\"editDataForm\" class=\"userData d-flex flex-column mx-auto justify-content-center\" style=\"width: 100%\">\n\n      <div class=\"data row col-6 mx-auto\" *ngIf=\"isCompany; else isUser\">\n        <label class=\"w-100 mt-3\">Nombre de empresa:</label>\n        <input type=\"text mt-1\" class=\"userName\" required formControlName=\"userName\">\n      </div>\n\n      <div class=\"data row col-6 mx-auto\">\n        <label class=\"w-100 mt-3\">Email:</label>\n        <input class=\"email mt-1 noEditable\" formControlName=\"email\" readonly>\n      </div>\n\n\n      <ng-template #isUser>\n        <div class=\"data row col-6 mx-auto\">\n          <label class=\"w-100\">Nombre:</label>\n          <input class=\"firstName mt-1 noEditable\" formControlName=\"firstName\" readonly>\n        </div>\n\n        <div class=\"data row col-6 mx-auto\">\n          <label class=\"w-100 mt-3\">Apellido(s):</label>\n          <input class=\"lastName mt-1 noEditable\" formControlName=\"lastName\" readonly>\n        </div>\n\n        <div class=\"data row col-6 mx-auto\">\n          <label class=\"w-100 mt-3\">Nombre de usuario:</label>\n          <input type=\"text mt-1\" class=\"userName\" required formControlName=\"userName\">\n        </div>\n      </ng-template>\n\n      <form [formGroup]=\"fileForm\" class=\"row col-6 mx-auto\">\n        <label class=\"w-100 mt-4\">Actualizar foto:</label>\n        <input type=\"file\" class=\"mt-1 changeFile\" (change)=\"changeFile($event)\" formControlName=\"file\" accept=\".jpeg, .webp, .png, .jpg\">\n        <button class=\"btn btn-secondary loadFile mt-1\" (click)=\"loadFile()\">Cargar archivo</button>\n      </form>\n    </form>\n\n    <div class=\"row col-6 mx-auto\">\n      <button class=\"btn saveChanges my-4\" (click)=\"updateUserData()\">Guardar cambios</button>\n    </div>\n\n  </div>\n  \n</ion-content>\n<app-footer></app-footer>\n\n\n\n<link href=\"https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css\" rel=\"stylesheet\" integrity=\"sha384-1BmE4kWBq78iYhFldvKuhfTAU6auU8tT94WrHftjDbrCEXSU1oBoqyl2QvZ6jIW3\" crossorigin=\"anonymous\">  \n<script src=\"https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js\" integrity=\"sha384-ka7Sk0Gln4gmtz2MlQnikT1wXgYsOg+OMhuP+IlRH9sENBO0LRn5q+8nbTov4+1p\" crossorigin=\"anonymous\"></script>    \n";
